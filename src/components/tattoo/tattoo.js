...
const Tattoo = () => {
  return (
    <div className="tattoo">
        <div className="tattoo__header__wrapper">
            <h2 className="tattoo__header">Wer wir sind und was dich erwartet</h2>
        </div>
        <div className="tattoo__main">
            <div className="tattoo__main__row">
                <div className="tattoo__main__text__wrapper">
                    <div className="tattoo__main__text__header__wrapper">
                        <h3 className="tattoo__main__text__header">WIR MACHEN DEINE WÜNSCHE WAHR!</h3>
                        <h4>Liebe deine Tattoos</h4>
                    </div>
                    <div className="tattoo__main__text__paragraph__wrapper">
                        <p className="tattoo__main__text__paragraph">
                ...
                <div className="tattoo__main__image__wrapper -upper">
                    <img src={imgSchnecke} alt="img-schnecke" className="tattoo__main__image"></img>
                    <img src={imgWaschbär} alt="img-schnecke" className="tattoo__main__image"></img>
                </div>
            </div>
            <div className="tattoo__main__row">
                <div className="tattoo__main__image__wrapper -lower">
                    <img src={imgSchädel} alt="img-schädel" className="tattoo__main__image"></img>
                    <img src={imgBlumen} alt="img-blumen" className="tattoo__main__image"></img>
                </div>
                <div className="tattoo__main__text__wrapper">
                    <div className="tattoo__main__text__header__wrapper">
                        <h3 className="tattoo__main__text__header">DEINE IDEEN</h3>
