...
const Piercing = () => {
  return (
    <section className="piercing standard--center" id="piercings">
      ...
      <div className="piercing__row standard--width">
        <div className="piercing__text">
          <h3 className="header--small">KOMM IN DEN PIERCINGHIMMEL</h3>
          <p className="text--medium">
            Wir denken an dich! Bei uns bekommst du die wahrscheinlich ehrlichste Piercingberatung, die man sich nur wünschen kann. Uns geht es nicht nur darum DIR deinen Wunsch zu erfüllen, wir werden dir auch ehrlich von Piercings abraten, wenn sie zu Gefährlich sind, deine Anatomie nicht passend ist oder wenn du unsere Meinung wissen möchtest, ob dir das Piercing steht oder nicht. 
            Wir klären DICH zu 100% auf, damit du gut vorbeireitet bist, dich gut um dein Piercing zu kümmern. Du darfst uns auch immer mit deinen Fragen löchern. 
